...
exports.initMultiWindow = initMultiWindow;
exports.saveWindowState = saveWindowState;
exports.restoreWindowState = restoreWindowState;
exports.onWindowGeometryChange = onWindowGeometryChange;
...
function addWindowManagerButton() {
    ...
    if (!toolbar)
        return;
    if (document.getElementById('windowManagerBtn'))
        return;
...
function onWindowGeometryChange() {
    ...
    geometrySaveTimer = setTimeout(async () => {
        if (!currentWindowId || !isWailsAvailable() || !WailsAPI?.updateWindowGeometry)
            return;
        try {
