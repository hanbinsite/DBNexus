...
exports.initAIChat = initAIChat;
exports.openAIChatPanel = openAIChatPanel;
exports.closeAIChatPanel = closeAIChatPanel;
exports.sendAIChatMessage = sendAIChatMessage;
exports.insertSQLToEditor = insertSQLToEditor;
exports.analyzeIndexes = analyzeIndexes;
...
function displayIndexAnalysis(result) {
    ...
    if (result.existingIndexes?.length)
